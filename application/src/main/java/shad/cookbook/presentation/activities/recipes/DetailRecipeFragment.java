...
public class DetailRecipeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mNameTextView = view.findViewById(R.id.detail_recipe_fragment_name);
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstance) {
        ...
        mId = this.getActivity().getIntent().getExtras().getFloat("id", -1f);
        mNameTextView.setText("<" + mId + ">");
//        mNameTextView.setAdapter(new ListRecipesFragmentRecyclerViewAdapter(((CookBookApplication) getActivity().getApplication()).recipes));
//        mNameTextView.setLayoutManager(new LinearLayoutManager(getActivity()));
    }
...
//                    Intent intent = new Intent(DetailRecipeFragment.this.getActivity(), DetailRecipeActivity.class);
